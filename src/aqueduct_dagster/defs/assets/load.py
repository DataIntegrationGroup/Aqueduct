...
Terminal load assets — one per source — backed by a shared private helper.
  ...
  frost_load_pvacd_hydrovu   upstream: canonical_bundles_pvacd_hydrovu
  frost_load_bernco_hydrovu  upstream: canonical_bundles_bernco_hydrovu
...
def _make_frost_load_asset(name: str, dataset: str) -> Any:
    ...
    HydroVuTransformResult, BerncoHydroVuTransformResult and CabqTransformResult all satisfy
    this contract; tests/defs/test_definitions.py checks it for every registry entry.
    """
