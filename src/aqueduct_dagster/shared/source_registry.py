...
Adding a new source means adding one entry here — nothing else needs a
matching, separately-maintained config list, and there's no way for one
consumer to see a source that another doesn't.
...
class SourceConfig(TypedDict):
    ...
    # GCS dataset name — used for the FROST watermark store and transform watermark path
    dataset: str
